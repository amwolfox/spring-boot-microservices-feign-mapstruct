...
package com.openfeign.employee_service.controller;

import com.openfeign.employee_service.response.EmployeeResponse; // DTO returned to client (Employee + Address).
import com.openfeign.employee_service.service.EmployeeService;  // Service layer containing business logic.
