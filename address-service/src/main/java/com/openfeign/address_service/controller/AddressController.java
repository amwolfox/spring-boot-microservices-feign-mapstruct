...
package com.openfeign.address_service.controller;

import com.openfeign.address_service.response.AddressResponse; // DTO returned to client (address details).
import com.openfeign.address_service.service.AddressService;  // Service layer containing business logic.
